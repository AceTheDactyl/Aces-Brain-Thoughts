...
APL Tier-3 now spans two complementary domains:

\begin{table}[h]
\centering
\begin{tabular}{@{}lll@{}}
\toprule
\textbf{Aspect} & \textbf{Chemical Domain} & \textbf{Biology Domain} \\
\midrule
Total Tokens & 972 & 972 \\
Operator Count & 18 & 18 \\
Primary Focus & Molecular transformations & Living systems \\
Operator Type & Process-only & Entity + Process \\
Primary Field & e (Energy) & π (Emergence) \\
Key Feature & Reversibility (oxidize/reduce) & Hierarchy (complexity ladder) \\
Central Concept & Electron transfer & Information flow \\
\bottomrule
\end{tabular}
\end{table}

\textbf{Combined Tier-3 Total:} 972 + 972 = \textbf{1,944 tokens}
